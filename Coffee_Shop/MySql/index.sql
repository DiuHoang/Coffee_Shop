...
select o.id, o.name_cus, o.address_cus, o.phone_cus, p.name as name_product, o.size_product, o.quantity_product,  p.price*o.quantity_product as price_product from orders as o, products as p 
where o.id = p.id ORDER BY price_product ASC;
